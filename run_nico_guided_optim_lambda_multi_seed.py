...
NICO optim_lambda best hyperparameters (attention_epoch fixed to 0).
"""
...
# Best hyperparameters per domain (from optim_lambda sweeps)
DOMAIN_BEST = {
    "autumn": {
        "pre_lr": 3.640107841202658e-05,
        "post_lr": 6.542787997164402e-05,
        "kl_lambda_start": 5.484732620082624,
        "kl_increment": 0.9019729196154559,
    },
    "rock": {
        "pre_lr": 3.669056841392929e-05,
        "post_lr": 5.445231276640402e-05,
        "kl_lambda_start": 5.902436813438827,
        "kl_increment": 0.5843396126815039,
    },
    "dim": {
        "pre_lr": 3.36355609849275e-05,
        "post_lr": 6.425618211173286e-05,
        "kl_lambda_start": 5.821538606337383,
        "kl_increment": 0.7003621402306436,
    },
    "grass": {
        "pre_lr": 9.6549865246113e-05,
        "post_lr": 5.723963981808867e-05,
        "kl_lambda_start": 5.006599137641149,
        "kl_increment": 0.727144614477471,
    },
    "outdoor": {
        "pre_lr": 8.941835801720977e-05,
        "post_lr": 6.826846311570653e-05,
        "kl_lambda_start": 5.614826778124637,
        "kl_increment": 0.721030993143525,
    },
    "water": {
        "pre_lr": 8.164236702296508e-05,
        "post_lr": 7.062167214457757e-05,
        "kl_lambda_start": 5.594198103343315,
        "kl_increment": 0.5635806974807647,
    },
}
...
def main():
    parser = argparse.ArgumentParser(description='Run 5-seed guided CNN per domain (optim_lambda).')
    ...
    summary_path = os.path.join(args.output_dir, "optim_lambda_seeded_summary.csv")
    summary_header = [
    ...
    for domain in targets:
        ...
        print(f"\n=== Domain: {domain} ===")
        print(
            "Hyperparams: pre_lr={:.6g} post_lr={:.6g} att_epoch={} kl_start={:.6g} kl_inc={:.6g}".format(
                pre_lr, post_lr, attention_epoch, kl_lambda_start, kl_increment
            )
        )
