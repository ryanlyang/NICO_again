...
#SBATCH --mem=128G
#SBATCH --output=logsNICO/open_nico_multi_seed_%j.out
#SBATCH --error=logsNICO/open_nico_multi_seed_%j.err
...
#CHANGE RIGHT HERE
MASK_ROOT=${MASK_ROOT:-/home/ryreu/guided_cnn/code/SwitchCLIP/LearningToLook/code/WeCLIPPlus/results/val/prediction_cmap}
#CHANGE RIGHT HERE
