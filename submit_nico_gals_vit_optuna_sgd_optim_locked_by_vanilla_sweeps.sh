...
for TARGET in "autumn rock" "dim grass" "outdoor water"; do
  ...
  STUDY_NAME="nico_gals_vit_sgd_optim_locked_vanilla_${TARGET_TAG}" \
  OPTUNA_STORAGE="${OPTUNA_STORAGE:-sqlite:///$OUTPUT_DIR/optuna_nico_gals_vit_sgd_optim_locked_vanilla_v1_${TARGET_TAG}.db}" \
  sbatch "$JOB_SCRIPT"
done
