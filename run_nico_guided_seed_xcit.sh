...
#SBATCH --mem=128G
#SBATCH --output=logsNICO/xcit_nico_multi_seed_%j.out
#SBATCH --error=logsNICO/xcit_nico_multi_seed_%j.err
...
#CHANGE RIGHT HERE
MASK_ROOT=${MASK_ROOT:-/home/ryreu/guided_cnn/code/SwitchDINO/LearningToLook/code/WeCLIPPlus/results/val/prediction_cmap}
#CHANGE RIGHT HERE
