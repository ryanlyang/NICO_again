...
Table 9 protocol settings and domain-specific best hyperparameters.
"""
...
DOMAIN_BEST = {
    "autumn": {
        "pre_lr": 5.409229331480416e-05,
        "post_lr_ratio": 0.06518171091474963,
        "attention_epoch": 4,
        "kl_lambda_start": 6.6198985122084135,
    },
    "rock": {
        "pre_lr": 3.7176749205526785e-05,
        "post_lr_ratio": 0.2823172229906076,
        "attention_epoch": 6,
        "kl_lambda_start": 5.005119552493245,
    },
    "dim": {
        "pre_lr": 5.042817897718851e-05,
        "post_lr_ratio": 0.21530928984641884,
        "attention_epoch": 6,
        "kl_lambda_start": 5.005119552493245,
    },
    "grass": {
        "pre_lr": 3.380163044599815e-05,
        "post_lr_ratio": 0.13530735859061732,
        "attention_epoch": 6,
        "kl_lambda_start": 5.001549289776776,
    },
    "outdoor": {
        "pre_lr": 2.9391371673296714e-05,
        "post_lr_ratio": 0.05656501988101606,
        "attention_epoch": 5,
        "kl_lambda_start": 5.5614047286533115,
    },
    "water": {
        "pre_lr": 3.454771035857174e-05,
        "post_lr_ratio": 0.0840741800525632,
        "attention_epoch": 5,
        "kl_lambda_start": 5.135189897518264,
    },
}
...
def main():
    parser = argparse.ArgumentParser(description='Run 5-seed guided CNN per domain with fixed hyperparameters.')
    ...
    for domain in targets:
        ...
        print(f"\n=== Domain: {domain} ===")
        print(f"Hyperparams: pre_lr={pre_lr} post_lr={post_lr} att_epoch={attention_epoch} kl_start={kl_lambda_start}")
